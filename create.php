          ...
          <div class="card">
            ...
            <form class="form-horizontal" action="create.php" method="post">
                ...
                <div class="control-group <?php echo !empty($telefoneErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="35" class="form-control" name="telefone" type="number" placeholder="Telefone" maxlength="11" required="" value="<?php echo !empty($telefone)?$telefone: '';?>">
                        <?php if(!empty($emailErro)): ?>
                ...
                <div class="control-group <?php echo !empty($emailErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="40" class="form-control" name="email" type="email" placeholder="Email" required="" value="<?php echo !empty($email)?$email: '';?>">
                        <?php if(!empty($emailErro)): ?>
